export const translations = {
  en: {
    'plugin-translator': {
      ...
      resolver_aiSDK_buttonLabel: 'AI Translate',
      resolver_aiSDK_errorMessage: 'An error occurred when trying to translate the data',
      resolver_aiSDK_modalTitle: 'Choose the locale to translate from',
      resolver_aiSDK_submitButtonLabelEmpty: 'Translate only empty fields',
      resolver_aiSDK_submitButtonLabelFull: 'Translate all',
      resolver_aiSDK_successMessage: 'Successfully translated. Press "Save" to apply the changes.',
    },
  },
  ar: {
    'plugin-translator': {
      resolver_copy_buttonLabel: 'نسخ من لغة أخرى',
      resolver_copy_errorMessage: 'حدث خطأ أثناء محاولة نسخ المحتوى',
      resolver_copy_modalTitle: 'اختر اللغة المصدر للنسخ',
      resolver_copy_submitButtonLabelEmpty: 'نسخ الحقول الفارغة فقط',
      resolver_copy_submitButtonLabelFull: 'نسخ الكل',
      resolver_copy_successMessage: 'تمت النسخ بنجاح. اضغط "حفظ" لتطبيق التغييرات.',

      resolver_aiSDK_buttonLabel: 'ترجمة AI',
      resolver_aiSDK_errorMessage: 'حدث خطأ أثناء محاولة ترجمة المحتوى',
      resolver_aiSDK_modalTitle: 'اختر اللغة المصدر للترجمة',
      resolver_aiSDK_submitButtonLabelEmpty: 'ترجمة الحقول الفارغة فقط',
      resolver_aiSDK_submitButtonLabelFull: 'ترجمة الكل',
      resolver_aiSDK_successMessage: 'تمت الترجمة بنجاح. اضغط "حفظ" لتطبيق التغييرات.',
    },
  },
}
