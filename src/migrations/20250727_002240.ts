...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "featuresBlock_columns" ADD COLUMN "stat_indicator" "enum_featuresBlock_columns_stat_indicator" DEFAULT 'noChange';
  ALTER TABLE "_featuresBlock_v_columns" ADD COLUMN "stat_value" varchar;
  ALTER TABLE "_featuresBlock_v_columns" ADD COLUMN "stat_indicator" "enum__featuresBlock_v_columns_stat_indicator" DEFAULT 'noChange';
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "featuresBlock_columns" DROP COLUMN IF EXISTS "stat_indicator";
  ALTER TABLE "_featuresBlock_v_columns" DROP COLUMN IF EXISTS "stat_value";
  ALTER TABLE "_featuresBlock_v_columns" DROP COLUMN IF EXISTS "stat_indicator";`)
}
