    ...
    <div className="container grid min-h-screen w-full grid-cols-8 items-center justify-center max-lg:mt-header-plus-admin-bar lg:grid-cols-16 lg:py-0">
      <div className="relative z-1 col-span-8 my-10 flex flex-col items-start gap-6 md:gap-10 lg:col-span-7 lg:my-16">
        {announcement && (
          ...
          >
            <Badge color="gray" size="md" label={locale === 'ar' ? 'تحديث' : 'Update'} />
      ...
      <div className="relative z-0 col-span-8 block select-none lg:col-start-10">
        {media && typeof media === 'object' && (
          <Media
            className="relative aspect-1728/1117 h-[350px] w-auto sm:h-auto sm:w-full lg:h-auto lg:w-[70vw]"
            imgClassName="h-full w-auto rounded-2xl object-cover object-right outline-4 outline-ring/50"
            priority
            media={media}
            size="(min-width: 1024px) 70vw, (min-width: 640px) calc(100vw - 2rem), 542px"
          />
        )}
